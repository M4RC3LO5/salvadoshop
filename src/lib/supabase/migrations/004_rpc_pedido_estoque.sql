-- ============================================================
-- SalvadoShop — RPC: criação atômica de pedido + baixa de estoque
-- Migração: 004_rpc_pedido_estoque.sql
-- Criado em: 2026-07-01
-- Contexto: Bloco 6, item 29 — o pedido é criado ANTES do checkout
-- (ao clicar "Continuar"), não no webhook. A baixa de estoque
-- precisa ser atômica para evitar overselling em concorrência, e o
-- preço unitário é lido de `produtos.preco_site` (nunca confiado
-- do cliente) para impedir manipulação de preço.
-- ============================================================
